let toSolve = ""; // real calculate
    ...
    function notImplemented(){
        ...
        function solve(){
            ...
            document.querySelector('.Answer').value = result; // display it for the user
        ...
        function deleteLastChar(){
            ...
            let checkForOperator_2nd = toSolve.slice(-3)
            ...
            document.querySelector('.Answer').value = document.querySelector('.Answer').value.slice(0, -cutFrom_display)
        }